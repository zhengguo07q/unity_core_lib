...
public static class ScriptHelper
{
    ...
    public static object GetObject(this LuaSvr luaSvr, string path)
    {
        return luaSvr.luaState.getObject(path);
    }


    public static void SetObject(this LuaSvr luaSvr, string path, object value)
    {
        luaSvr.luaState.setObject(path, value);
    }
}
